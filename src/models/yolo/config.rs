use crate::{models::YOLOPredsFormat, Options, ResizeMode, Scale, Task, Version, COCO_KEYPOINTS_NAMES_17};
...
impl Options {
    ...
    pub fn doclayout_yolo_docstructbench() -> Self {
        Self::yolo_v10()
            .with_model_file("model.onnx") // TODO: batch_size > 1
	...
	pub fn doclayout_yolo_docsynth() -> Self {
        Self::yolo()
            ...
            .with_model_version(Version(10, 0)) // YOLOv10
            .with_iou(0.7)
            .with_apply_nms(false) // YOLOv10 handles NMS
    }
